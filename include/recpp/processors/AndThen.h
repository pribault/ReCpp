...
namespace recpp::processors
{
	 ...
	 * @brief {@link rscpp::Processor} that will subscribe to a given {@link rscpp::Publisher} and request items until completion AND THEN subscribe to a second {@link rscpp::Publisher}
	...
	public:
		 ...
		 * @param dest The destination {@link rscpp::Publisher} the {@link AndThen} {@link rscpp::Processor} will subscribe to after the source {@link rscpp::Publisher} completion.
		 */
