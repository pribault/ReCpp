...
template <typename T, typename R>
recpp::processors::AndThen<T, R>::Impl::Impl(rscpp::Processor<T, R> &parent, const rscpp::Publisher<T> &source, const rscpp::Publisher<R> &dest)
	: m_parent(parent)
	, m_source(source)
	, m_dest(dest)
{
...
template <typename T, typename R>
void recpp::processors::AndThen<T, R>::Impl::onNext(const T &)
{
	m_remaining--;
	if (!m_remaining)
	{
...
template <typename T, typename R>
void recpp::processors::AndThen<T, R>::Impl::subscribe(rscpp::Subscriber<R> &subscriber)
{
