...
template <typename T, typename R>
recpp::processors::FlatMap<T, R>::Impl::Impl(rscpp::Processor<T, R> &parent, const rscpp::Publisher<T> &publisher,
...
template <typename T, typename R>
void recpp::processors::FlatMap<T, R>::Impl::onNext(const T &value)
{
...
template <typename T, typename R>
void recpp::processors::FlatMap<T, R>::Impl::onComplete()
{
	m_completed = true;
...
template <typename T, typename R>
void recpp::processors::FlatMap<T, R>::Impl::subscribe(rscpp::Subscriber<R> &subscriber)
{
