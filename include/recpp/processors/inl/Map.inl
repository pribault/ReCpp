...
recpp::processors::Map<T, R>::Map(const rscpp::Publisher<T> &publisher, const std::function<R(const T & /* value */)> &method)
...
template <typename T, typename R>
void recpp::processors::Map<T, R>::Impl::onNext(const T &value)
{
...
template <typename T, typename R>
void recpp::processors::Map<T, R>::Impl::subscribe(rscpp::Subscriber<R> &subscriber)
{
