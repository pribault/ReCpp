...
namespace recpp::processors
{
	...
	class NoneOf : public rscpp::Processor<T, bool>
	{
	...
	public:
		/**
		 * @brief Construct a new {@link NoneOf} instance.
		 *
		 * @param publisher The source {@link rscpp::Publisher} the {@link NoneOf} {@link rscpp::Processor} subscribes to.
		 * @param predicate The predicate to call on each value.
		 */
		explicit NoneOf(const rscpp::Publisher<T> &publisher, R predicate);
	};
} // namespace recpp::processors

#include <recpp/processors/inl/NoneOf.inl>
