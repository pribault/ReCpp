...
{
	return Maybe<T>(std::shared_ptr<rscpp::Publisher<T>>(new recpp::publishers::CreatePublisher<T, recpp::subscribers::MaybeSubscriber<T>>(method)));
}

template <typename T>
recpp::rx::Maybe<T> recpp::rx::Maybe<T>::defer(const std::function<Maybe<T>()> &function)
{
	return Maybe<T>(std::shared_ptr<rscpp::Publisher<T>>(new recpp::publishers::DeferPublisher<T, Maybe<T>>(function)));
}

template <typename T>
recpp::rx::Maybe<T> recpp::rx::Maybe<T>::empty()
{
	return Maybe<T>(std::shared_ptr<rscpp::Publisher<T>>(new recpp::publishers::EmptyPublisher<T>()));
}

template <typename T>
recpp::rx::Maybe<T> recpp::rx::Maybe<T>::error(const std::exception_ptr &error)
{
	return Maybe<T>(std::shared_ptr<rscpp::Publisher<T>>(new recpp::publishers::ErrorPublisher<T>(error)));
}

template <typename T>
recpp::rx::Maybe<T> recpp::rx::Maybe<T>::just(const T &value)
{
	return Maybe<T>(std::shared_ptr<rscpp::Publisher<T>>(new recpp::publishers::JustPublisher<T>(value)));
}

template <typename T>
recpp::rx::Maybe<T> recpp::rx::Maybe<T>::never()
{
	return Maybe<T>(std::shared_ptr<rscpp::Publisher<T>>(new recpp::publishers::NeverPublisher<T>()));
}
...
{
	return Maybe<R>(std::shared_ptr<rscpp::Publisher<R>>(new processors::Map<T, R>(*this, method)));
}
...
{
	return Maybe<R>(std::shared_ptr<rscpp::Publisher<R>>(new processors::FlatMap<T, R>(*this, method)));
}
...
{
	return Maybe<T>(std::shared_ptr<rscpp::Publisher<T>>(new processors::Tap<T>(*this, nullptr, nullptr, method)));
}

template <typename T>
recpp::rx::Maybe<T> recpp::rx::Maybe<T>::doOnError(const OnErrorMethod &method)
{
	return Maybe<T>(std::shared_ptr<rscpp::Publisher<T>>(new processors::Tap<T>(*this, nullptr, method, nullptr)));
}

template <typename T>
recpp::rx::Maybe<T> recpp::rx::Maybe<T>::doOnNext(const OnNextMethod &method)
{
	return Maybe<T>(std::shared_ptr<rscpp::Publisher<T>>(new processors::Tap<T>(*this, method, nullptr, nullptr)));
}

template <typename T>
recpp::rx::Maybe<T> recpp::rx::Maybe<T>::doOnTerminate(const OnCompleteMethod &method)
{
	return Maybe<T>(std::shared_ptr<rscpp::Publisher<T>>(new processors::Tap<T>(
...
{
	return Maybe<T>(std::shared_ptr<rscpp::Publisher<T>>(new processors::Tap<T>(*this, onNextMethod, onErrorMethod, onCompleteMethod)));
}

template <typename T>
recpp::rx::Maybe<T> recpp::rx::Maybe<T>::observeOn(recpp::async::Scheduler &scheduler)
{
	return Maybe<T>(std::shared_ptr<rscpp::Publisher<T>>(new processors::ObserveOn<T>(*this, scheduler)));
}

template <typename T>
recpp::rx::Maybe<T> recpp::rx::Maybe<T>::subscribeOn(recpp::async::Scheduler &scheduler)
{
	return Maybe<T>(std::shared_ptr<rscpp::Publisher<T>>(new processors::SubscribeOn<T>(*this, scheduler)));
}
